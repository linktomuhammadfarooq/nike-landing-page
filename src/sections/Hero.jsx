  ...
  return (
    ...
    >
      <div className="relative flex flex-col items-start justify-center w-full xl:w-2/5 max-xl:padding-x pt-28">
        ...
        <p className="mt-6 text-lg font-montserrat mb-14 text-slate-gray sm:max-w-sm">
          Discover stylish Nike arrivals, quality confort, adn innovation for
          your active life.
        </p>
          ...
          {shoes.map((shoe) => (
            <div key={shoe.thumbnail}>
              <ShoeCard
                ...
                changeBidShoeImage={setBigShoeImg}
